...
| 4 | Cutoff verification | Llama-3.1 is externally verified. Qwen2.5 uses its official release date as the conservative cutoff. Olmo3 still requires direct corpus-metadata verification. |
